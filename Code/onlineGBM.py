# -*- coding: utf-8 -*-
"""
Created on Sat Mar 31 14:48:32 2018
...
if __name__ == "__main__":
    ...
    best_iter,model = lgbCV(train, test)
    "----------------------------------------------------线上----------------------------------------"
    train = data[data.is_trade.notnull()]
    test = data[data.is_trade.isnull()]
    '''xx = sub(train, test, best_iter)
    xx.to_csv('../../Submission/advertisement/result401.txt',sep=" ",index=False)
    xx.predicted_score = xx.predicted_score-xx.predicted_score.mean()+0.016983086400719192
    xx.loc[xx.predicted_score<0,'predicted_score']=0'''
