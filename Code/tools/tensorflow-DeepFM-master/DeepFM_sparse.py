...
class DeepFM(BaseEstimator, TransformerMixin):
    ...
    def _init_graph(self):
        ...
        with self.graph.as_default():
            ...
            self.feat_input = tf.sparse_placeholder(tf.float32,shape=[None,None])
            self.feat_input = tf.sparse_to_dense(self.feat_input.indices,self.feat_input.dense_shape,self.feat_input.values)
