# -*- coding: utf-8 -*-
"""
Created on Thu Mar 22 11:24:39 2018
...
if __name__ == "__main__":
    ...
    data = pd.read_csv('../../Data/advertisment/Raw/round1_ijcai_18_train_20180301.txt', sep=' ')
    ...
    if online == False:
        ...
        train = data.copy()
        test = pd.read_csv('../../Data/advertisment/Raw/round1_ijcai_18_test_a_20180301.txt', sep=' ')
